...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'north',split:true" style="height:50px">
        <div style="margin-top: 10px;margin-left: 10px">
            ...
            一级:<select data-options="width:200" class="easyui-combobox" id="attr_class_1_select"
                       onchange="get_attr_class_2(this.value);">
            <option>请选择</option>
        </select>
            二级:<select data-options="width:200" class="easyui-combobox" id="attr_class_2_select"
                ...
                {field: 'shxm_mch', title: '属性名', width: 100},
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        $(value).each(function (i, json) {
                            // alert(json.shxzh+json.shxzh_mch);
